...
import { ArrowDown, ArrowUp, ArrowUpRight, Link2, Plus } from "lucide-react";
        ...
        return (
          <div className="mb-4">
            ...
            <p className="text-gray-500">
              Sender Account: {transaction.sender_account_number}
            </p>
            <p className="text-gray-500">
              Recipient Account: {transaction.recipient_account_number}
            </p>
          </div>
        );
      ...
      case "interbank":
        return (
          <div className="mb-4">
            ...
            <p className="text-gray-500">
              Routing Number: {transaction.routing_number}
            </p>
            <p className="text-gray-500">
              Sender Account: {transaction.sender_account_number}
            </p>
      ...
      case "international":
        return (
          <div className="mb-4">
            ...
            <p className="text-gray-500">
              Recipient Name: {transaction.recipient_name}
            </p>
            <p className="text-gray-500">
              Swift Code: {transaction.swift_code}
            </p>
            <p className="text-gray-500">
              Recipient Address: {transaction.recipient_address}
            </p>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end justify-center">
      ...
      >
        ...
        <div
          className={`rounded-xl p-4 mb-4 font-semibold ${transaction.status == "completed" ? "bg-green-500" : "bg-orange-500"}`}
        >
        ...
        <p className="text-gray-500 mb-4">
          Transaction no. trns_{transaction.id.toString().padStart(6, "0")}
        </p>
        ...
        <p className="text-gray-600 font-bold  mb-4">
          Status:{" "}
          <span className="capitalize font-semibold">{transaction.status}</span>
        </p>

        <button
          className="text-red-500 w-full py-2 border border-red-500 rounded-lg mb-2"
          onClick={onClose}
        >
          Report a problem
        </button>
    ...
    <>
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <Link to={"/history"} className="text-emerald-600 text-sm">
            View all
          </Link>
        </div>
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center mr-3">
                  <span className="text-lg">
                    {transaction.transfer_type == "credit" ? (
                      <ArrowDown size={20} />
                    ) : (
